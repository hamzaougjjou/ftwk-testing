    ...
    return (
        <>
            ...
            <svg
                ...
                viewBox="0 0 333.815 333.815" xmlSpace="preserve">
                <g id="XMLID_1400_">
                    <g id="XMLID_1401_">
                        <g id="XMLID_1402_">
			...
			C231.43,231.581,198.639,226.526,198.639,156.886z"/>
                    ...
                    <g id="XMLID_1405_">
                        ...
                        <ellipse id="XMLID_65_" transform="matrix(0.3543 -0.9351 0.9351 0.3543 41.877 286.6909)" style={{ fill: "#EDCEAE" }} cx="228.54" cy="113.021" rx="17.187" ry="10.048" />

                        <ellipse id="XMLID_64_" transform="matrix(0.3543 0.9351 -0.9351 0.3543 172.9698 -24.4475)" style={{ fill: "#F3DBC4" }} cx="104.188" cy="113.029" rx="17.187" ry="10.048" />
                    </g>
                    <g id="XMLID_1406_">
                        <g id="XMLID_1407_">
			...
			c1.992,20.419,2.988,16.854,2.988,16.854s8.92-9.712,8.466-23.407C232.923,80.969,239.803,24.719,223.571,25.322z"/>
                    ...
                    <g id="XMLID_1435_">
                        ...
                        <ellipse id="XMLID_33_" transform="matrix(0.3543 -0.9351 0.9351 0.3543 41.877 286.6909)" style={{ fill: "#EDCEAE" }} cx="228.54" cy="113.021" rx="17.187" ry="10.048" />

                        <ellipse id="XMLID_32_" transform="matrix(0.3543 0.9351 -0.9351 0.3543 172.9698 -24.4475)" style={{ fill: "#F3DBC4" }} cx="104.188" cy="113.029" rx="17.187" ry="10.048" />
                    </g>
                </g>
            </svg>
        </>
