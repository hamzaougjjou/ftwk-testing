...
function ReletedProduct( { current_product_id } ) {

    const { data, loading, error } = useAxios(`/product/${current_product_id}/releted-products`, {
        method: 'GET',
    });
            ...
            <div className="2xl:mx-auto 2xl:container py-12 px-4 sm:px-6 xl:px-20 2xl:px-0 w-full">
                <div className="flex flex-col jusitfy-center items-center space-y-10">
                    <div className="flex flex-col justify-center items-center ">
                        ...
                        font-bold leading-7 xl:leading-9 text-green-400
                        dark:text-black">
                        Releted Products
                        </h1>
                    </div>
